'''
Little program that ligts up Neopixel depending on battery percentage 
'''
...
def Battery_mercy():
    ...
    volts = (analog_val * 0.00097176101) #calculation for battery %
    round(volts, 1)
    battery_percentage = volts * 100 - 320
    n =battery_percentage
    # lights up neopixel from 1-10 pixels depending on batteery percentage
    if n <= 10:
        np[1] = (255, 0, 0, 128)
        np.write()
    elif n >= 10 and n <= 20:
